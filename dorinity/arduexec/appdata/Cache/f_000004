...
Blockly.Msg.REMOVE_COMMENT = "메모 제거";
Blockly.Msg.RENAME_VARIABLE = "변수 이름 바꾸기:";
Blockly.Msg.RENAME_VARIABLE_TITLE = "'%1' 변수 이름을 바꾸기:";
Blockly.Msg.SSERIAL_Avai = "소프트시리얼 활성여부";
Blockly.Msg.SSERIAL_DEFAULT_NAME = "BlueTooth";
Blockly.Msg.SSERIAL_Init = "소프트시리얼 설정";
Blockly.Msg.SSERIAL_Print = "소프트시리얼 출력";
Blockly.Msg.SSERIAL_RX = "RX#";
Blockly.Msg.SSERIAL_Read = "소프트시리얼 읽기";
Blockly.Msg.SSERIAL_SPEED = "속도";
Blockly.Msg.SSERIAL_TX = "TX#";
Blockly.Msg.SSERIAL_Write = "소프트시리얼 쓰기";
...
Blockly.Msg.VARIABLES_SET = "변수 %1 를 다음 값으로 설정하기 %2";
...
// Ardublockly strings
Blockly.Msg.ARD_ANALOGREAD = "아날로그 핀읽기 #";  // untranslated
Blockly.Msg.ARD_ANALOGREAD_TIP = "0 과 1024 범의 의값을 반환";  // untranslated
Blockly.Msg.ARD_ANALOGWRITE = "아날로그핀 설정 #";  // untranslated
Blockly.Msg.ARD_ANALOGWRITE_TIP = "0 ~ 255 사이의 아날로그 값을 특정 PWM 포트에 쓰기";  // untranslated
Blockly.Msg.ARD_BUILTIN_LED = "내장 LED 설정";  // untranslated
Blockly.Msg.ARD_BUILTIN_LED_TIP = "아두이노 내장 LED 를 온오프 설정";  // untranslated
Blockly.Msg.ARD_COMPONENT_WARN1 = "이 블록을 사용하려면 동일한 %2 이름을 가진 %1 구성 블록을 추가해야합니다!";  // untranslated
Blockly.Msg.ARD_DEFINE = "Define";  // untranslated
Blockly.Msg.ARD_DIGITALREAD = "디지탈핀 읽기#";  // untranslated
Blockly.Msg.ARD_DIGITALREAD_TIP = "핀상태를 읽기: HIGH or LOW";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE = "디지털핀 설정#";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE_TIP = "특정 포트에 디지털 값 HIGH 또는 LOW 쓰기";  // untranslated
Blockly.Msg.ARD_FUN_RUN_LOOP = "loop(  )";  // untranslated
Blockly.Msg.ARD_FUN_RUN_SETUP = "setup(  )";  // untranslated
Blockly.Msg.ARD_FUN_RUN_TIP = "아두이노의 setup() 과 loop() 함수를 정의합니다";  // untranslated
Blockly.Msg.ARD_HIGH = "HIGH";  // untranslated
Blockly.Msg.ARD_HIGHLOW_TIP = "핀상테를  High 또는 Low로 설정";  // untranslated
...
Blockly.Msg.ARD_NOTONE = "음향 끄기 pin #";  // untranslated
...
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "선택한 핀에서 펄스의 지속 시간을 측정합니다 (시간 제한이 마이크로 초 단위 인 경우).";  // untranslated
Blockly.Msg.ARD_PULSE_READ = "핀 # %2에서 %1 펄스 측정";  // untranslated
Blockly.Msg.ARD_PULSE_READ_TIMEOUT = "핀 # %2에서 %1 펄스 측정(timeout after %3 μs)";  // untranslated
Blockly.Msg.ARD_PULSE_TIP = "선택한 핀의 펄스 지속 시간을 측정합니다.";  // untranslated
Blockly.Msg.ARD_SERIAL_BPS = "bps";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT = "print";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "새라인을 추가";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "사람이 읽을 수있는 ASCII 텍스트로 콘솔 / 직렬 포트에 데이터를 인쇄합니다.";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "이 블록을 사용하려면 %1에 대한 설정 블록을 작업 영역에 추가해야합니다!";  // untranslated
Blockly.Msg.ARD_SERIAL_SETUP = "설정";  // untranslated
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "특정 직렬 주변 장치의 속도를 선택합니다.";  // untranslated
Blockly.Msg.ARD_SERIAL_SPEED = ":  속도 설정";  // untranslated
Blockly.Msg.ARD_SERVO_READ = "서보모터 값 읽기 PIN#";  // untranslated
Blockly.Msg.ARD_SERVO_READ_TIP = "Read a Servo angle";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE = "서보모터 설정 해당핀";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "각도 (0~180)";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TIP = "서보를 지정된 각도로 설정하십시오.";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TO = "to";  // untranslated
Blockly.Msg.ARD_SETTONE = "음향 설정 pin #";  // untranslated
...
Blockly.Msg.ARD_SPI_TRANSRETURN_TIP = "지정된 슬레이브 장치에 SPI 메시지를 보내고 데이터를 다시 가져옵니다.";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_NONE = "none";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "to slave pin";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_TIP = "지정된 슬레이브 장치에 SPI 메시지를 보냅니다.";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_VAL = "transfer";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_WARN1 = "이 블록을 사용하려면 %1에 대한 설정 블록을 작업 영역에 추가해야합니다!";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_WARN2 = "이전 핀 값 %1을 (를) 더 이상 사용할 수 없습니다.";  // untranslated
...
Blockly.Msg.ARD_STEPPER_NUMBER_OF_PINS = "핀의수";  // untranslated
...
Blockly.Msg.ARD_STEPPER_REVOLVS = "회전당 몇스텝";  // untranslated
Blockly.Msg.ARD_STEPPER_SETUP = "스텝모터 설정";  // untranslated
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "Configures a stepper motor pinout and other settings.";  // untranslated
Blockly.Msg.ARD_STEPPER_SPEED = "속도를 설정 (rpm) to";  // untranslated
Blockly.Msg.ARD_STEPPER_STEP = "스텝이동";  // untranslated
Blockly.Msg.ARD_STEPPER_STEPS = "스텝";  // untranslated
Blockly.Msg.ARD_STEPPER_STEP_TIP = "스테퍼 모터를 특정 스텝만큼 돌립니다.";  // untranslated
Blockly.Msg.ARD_STEPPER_TWO_PINS = "2";  // untranslated
Blockly.Msg.ARD_TIME_DELAY = "기다리기";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICROS = "마이크로세컨즈(microseconds)";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "특정시간동안 기다리기 microseconds";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_TIP = "특정시간동안 기다리기(microseconds)";  // untranslated
Blockly.Msg.ARD_TIME_INF = "계속해서 기다리기 (end program)";  // untranslated
Blockly.Msg.ARD_TIME_INF_TIP = "Wait indefinitely, stopping the program.";  // untranslated
Blockly.Msg.ARD_TIME_MICROS = "현재까지 경과시간(microseconds)";  // untranslated
...
Blockly.Msg.ARD_TIME_MILLIS = "현재까지 경과시간 (milliseconds)";  // untranslated
...
Blockly.Msg.ARD_TIME_MS = "밀리세컨즈(milliseconds)";  // untranslated
...
Blockly.Msg.ARD_TONE_WARNING = "주파수는 31 - 65535 범위 여야합니다.";  // untranslated
...
Blockly.Msg.ARD_VAR_AS_TIP = "값을 특정 유형으로 설정합니다.";  // untranslated

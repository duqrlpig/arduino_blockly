...
Blockly.Arduino.ultra_read = function(a) {
  var b = a.getFieldValue("PIN");
  Blockly.Arduino.reservePin(a, b, Blockly.Arduino.PinTypes.INPUT, "Digital Read");
  Blockly.Arduino.addSetup("io_" + b, "pinMode(" + b + ", INPUT);", !1);
  return ["digitalRead(" + b + ")", Blockly.Arduino.ORDER_ATOMIC]
...
Blockly.Arduino.cds_read = function(a) {
  var b = a.getFieldValue("PIN");
  Blockly.Arduino.reservePin(a, b, Blockly.Arduino.PinTypes.INPUT, "Analogue Read");
  Blockly.Arduino.addSetup("io_" + b, "pinMode(" + b + ", INPUT);", !1);
  return ["analogRead(" + b + ")", Blockly.Arduino.ORDER_ATOMIC]
...
Blockly.Arduino.rgb_led = function(w) {
  var a = w.getFieldValue("PIN_R");
  var b = w.getFieldValue("PIN_G");
  var c = w.getFieldValue("PIN_B");
  var d = w.getFieldValue("RGB0");
  Blockly.Arduino.setups_["setup_input_" + a] = "pinMode(" + a + ", OUTPUT);";
  Blockly.Arduino.setups_["setup_input_" + b] = "pinMode(" + b + ", OUTPUT);";
  Blockly.Arduino.setups_["setup_input_" + c] = "pinMode(" + c + ", OUTPUT);";
  var f = "digitalWrite(" + a + "," + hexToR(d) + ");\n"
   + "digitalWrite(" + b + "," + hexToG(d) + ");\n" + "digitalWrite(" + c + "," + hexToB(d) + ");\n"
  return f
};

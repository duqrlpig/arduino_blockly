...
Blockly.Arduino.softserial = {};

Blockly.Arduino.soft_init = function(a) {
  a = Blockly.Arduino.valueToCode(this, "PIN1", Blockly.Arduino.ORDER_ATOMIC);
  var b = Blockly.Arduino.valueToCode(this, "PIN2", Blockly.Arduino.ORDER_ATOMIC),
    c = this.getFieldValue("SOFTSERIAL_NAME"),
    d = this.getFieldValue("SPEED");
  Blockly.Arduino.addInclude("SoftwareSerial", "#include <SoftwareSerial.h>");
  Blockly.Arduino.addDeclaration("SoftwareSerial_" + c, "SoftwareSerial " + c + "(" + a + "," + b + ");");
  Blockly.Arduino.addSetup("SoftwareSerial_" + c, c + ".begin(" + d + ");", !1);
  return ""
};
Blockly.Arduino.soft_read = function(a) {
  return [this.getFieldValue("SOFTSERIAL_NAME") + ".read()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.soft_print = function(a) {
  a = this.getFieldValue("SOFTSERIAL_NAME");
  var b = Blockly.Arduino.valueToCode(this, "CONTENT", Blockly.Arduino.ORDER_ATOMIC) || "0";
  return a + ".println(" + b + ");\n"
};
Blockly.Arduino.soft_write = function(a) {
  a = this.getFieldValue("SOFTSERIAL_NAME");
  var b = Blockly.Arduino.valueToCode(this, "CONTENT", Blockly.Arduino.ORDER_ATOMIC) || "0";
  return a + ".write(" + b + ");\n"
};
Blockly.Arduino.soft_available = function(a) {
  return [this.getFieldValue("SOFTSERIAL_NAME") + ".available()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.soft_flush = function() {
  return this.getFieldValue("SOFTSERIAL_NAME") + ".flush();\n"
};

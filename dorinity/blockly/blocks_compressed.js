...
Blockly.Blocks.servo_write = {
  init: function() {
    ...
    this.appendDummyInput().appendField(Blockly.Msg.ARD_SERVO_WRITE)

    .appendField(new Blockly.FieldDropdown(Blockly.Arduino.Boards.selected.digitalPins), "SERVO_PIN");
    this.setInputsInline(!1);
...
Blockly.Blocks.soft_init = {
  init: function() {
    this.appendDummyInput().appendField("\ube14\ub8e8\ud22c\uc2a4").appendField(new Blockly.FieldLabel(Blockly.Msg.SSERIAL_DEFAULT_NAME), "SOFTSERIAL_NAME").appendField(new Blockly.FieldImage("https://ae01.alicdn.com/kf/HTB1u1muSVXXXXafXFXXq6xXFXXXT/AT-09-4-0-BLE-CC2541-HM-10-MCU.jpg", 50, 50));
    ...
    this.appendDummyInput().appendField(Blockly.Msg.SSERIAL_SPEED).appendField(new Blockly.FieldLabel("9600"), "SPEED");
    this.setInputsInline(!1);
    this.setPreviousStatement(!0, null);
    this.setNextStatement(!0, null);
...
Blockly.Blocks.dht11_temperature = {
  init: function() {
    this.setColour(190);
    this.appendDummyInput().appendField("DHT11 온도값 확인").appendField(new Blockly
        .FieldImage("https://images-na.ssl-images-amazon.com/images/I/61UUX6TA57L._SX425_.jpg", 64, 64))
      .appendField("PIN#")
...
Blockly.Blocks.dht11_humidity = {
  init: function() {
    this.setColour(190);
    this.appendDummyInput().appendField("DHT11 습도값 확인").appendField(new Blockly
        .FieldImage("https://images-na.ssl-images-amazon.com/images/I/61UUX6TA57L._SX425_.jpg", 64, 64))
      .appendField("PIN#")
      .appendField(new Blockly.FieldDropdown(Blockly.Arduino.Boards.selected.digitalPins), "PIN");
    this.setOutput(!0, "Number");
...
Blockly.Blocks.ultra_read = {
  init: function() {
    this.setColour(220);
    this.appendDummyInput().appendField("적외선 센서값 확인").appendField(new Blockly
        .FieldImage("http://songpamakers.com/mall/wp-content/uploads/sites/5/2017/05/irSensors-600x600.jpg", 64, 64))
      .appendField("PIN#")
      .appendField(new Blockly.FieldDropdown(Blockly.Arduino.Boards.selected.digitalPins), "PIN");
    this.setOutput(!0, "Number");
    this.setTooltip("When anyone moves in it's detecting range, the sensor outputs HIGH.")
...
Blockly.Blocks.cds_read = {
  init: function() {
    this.setColour(220);
    this.appendDummyInput().appendField("조도 센서값 확인")
      .appendField(new Blockly.FieldImage("https://www.eduino.kr/web/product/big/201803/234_shop1_610230.png", 64, 64))
      .appendField("PIN#")
      .appendField(new Blockly.FieldDropdown(Blockly.Arduino.Boards.selected.digitalPins), "PIN");
    this.setOutput(!0, "Number");
    this.setTooltip("When anyone moves in it's detecting range, the sensor outputs HIGH.")
...
Blockly.Blocks.io_tone = {
  init: function() {
    ...
    this.appendValueInput("FREQUENCY").setCheck(Blockly.Types.NUMBER.checkList)
...
Blockly.Blocks.rgb_led = {
  ...
  init: function() {
    this.setColour(190);
    this.appendDummyInput().appendField("RGB LED").appendField(new Blockly.FieldImage("https://ae01.alicdn.com/kf/HTB10SqJKb9YBuNjy0Fgq6AxcXXar/3-RGB-LED-Module-Sensor-Arduino-UNO.jpg_640x640.jpg", 64, 64))
      .appendField("PIN R").appendField(new Blockly.FieldDropdown(Blockly.Arduino.Boards.selected.digitalPins), "PIN_R")
      .appendField("PIN G").appendField(new Blockly.FieldDropdown(Blockly.Arduino.Boards.selected.digitalPins), "PIN_G")
      .appendField("PIN B").appendField(new Blockly.FieldDropdown(Blockly.Arduino.Boards.selected.digitalPins), "PIN_B");
